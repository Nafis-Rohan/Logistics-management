...
namespace project
{
    public partial class CustomPopupForm : Form
    {
        ...
        public delegate void OrderPlacedEventHandler(string productId, int newQuantity);
                ...
                using (SqlConnection connection = new SqlConnection(databaseConnection.database()))
                {
                    try
                    {
                        ...
                        if (updateRowsAffected > 0)
                        {
                            ...
                            int newq = (int)(numericUpDown1.Maximum - quantity);
                            ...
                            if (insertRowsAffected > 0)
                            {
                                ...
                                // Notify subscribers that an order has been placed successfully
                                OrderPlaced?.Invoke(pproductId, newq);
